...
class TestTransform:
    ...
    def test_transform_almost_equal(self):
        identity = Transform.identity()
        assert identity.almost_equal(identity)
    
    def test_transform_almost_equal_atol(self):
        identity = Transform.identity()
        assert identity.almost_equal(identity, atol=1e-8)
    
    def test_transform_almost_equal_atol_fail(self):
        t1 = Transform.identity()
        t2 = Transform(position=[0, 0, 0], rotation=Rotation.from_quat([0, 0, 0.01, 0.99]))
        assert not t1.almost_equal(t2)
    ...
    def test_transform_inverse_multiplication(self):
        position = [1, 2, 3]
        rotation = Rotation.from_quat([0, 0, 0, 1])
        transform = Transform(position, rotation)
    ...
    def test_transform_from_position_and_quaternion(self):
        position = [1, 2, 3]
        quaternion = [0, 0, 0, 1]
    ...
    def test_transform_from_matrix(self):
        position = [1, 2, 3]
        rotation = Rotation.from_quat([0, 0, 0, 1])
        transform = Transform(position, rotation)
    ...
    def test_transform_mul_transform(self):
        position1 = [1, 2, 3]
        quaternion1 = [0, 0, 0, 1]
    ...
    def test_transform_mul_sequence(self):
        position = [1, 2, 3]
        quaternion = [0, 0, 0, 1]
        transform = Transform.from_position_and_quaternion(position, quaternion)
    ...
    def test_transform_mul_sequence_2(self):
        position = [0, 0, 0]
    ...
    def test_interpolate(self):
        ...
        assert t1.angle_to(t_interpolated) == approx(t2.angle_to(t_interpolated))

    def test_zero_position_transform(self):
        zero_position = [0, 0, 0]
        rotation = Rotation.from_quat([0, 0, 0, 1])
        transform = Transform(zero_position, rotation)
        assert Transform.almost_equal(transform.inverse, Transform.identity())

    def test_identity_rotation_transform(self):
        position = [1, 2, 3]
    ...
    def test_transform_mul_invalid_sequence(self):
        position = [1, 2, 3]
        quaternion = [0, 0, 0, 1]
        transform = Transform.from_position_and_quaternion(position, quaternion)
    ...
    def test_large_position_transform(self):
