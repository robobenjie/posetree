...
class Transform(object):
    ...
    def apply(self, other: Union["Transform", Sequence[float], Sequence[Sequence[float]]]) -> "Transform":
        ...
        Args:
            other: The transform to multiply by.
...
class PoseTree(ABC):
    ...
    so by implementing _get_transform.
    ...
    def temporary_frame(self, pose: "Pose") -> str:
        ...
        Example 1, find an approach that is close to the robot base:
    ...
    def add_frame(self, pose: "Pose", name: str) -> None:
        ...
        Don't use this for temporary frames. Use the temporary_frame context manager instead. This should 
        be used for things like a workspace frame.
...
class CustomFramePoseTree(PoseTree, ABC):
    ...
    class and implement the _get_transform method and get full custom frame support.
    """
    def __init__(self) -> None:
        self.custom_frames = {}

    def add_frame(self, pose: "Pose", name: str) -> None:
        """Add a frame to the tree.
...
class Pose(object):
    """A pose is a location and rotation in 3D space."""
    def __init__(self, transform: Transform, parent_frame: str, pose_tree: PoseTree) -> None:
        ...
        Args:
            ...
            pose_tree: The worls that the pose exists in.
        """
    ...
    def transform(self) -> Transform:
        """The transform from the frame to the pose."""
    ...
    @property
    def frame(self) -> str:
        """The frame that the transform is relative to."""
        return self._frame
    
    @property
    def pose_tree(self) -> PoseTree:
        """The world that the pose exists in."""
    ...
    def with_position(self, position: Sequence[float]) -> "Pose":
        """Return a new pose with the same rotation but a different location.
    ...
    def with_position_x(self, x: float, *, frame: Optional[str] = None) -> "Pose":
        ...
        Args:
            ...
            frame: The frame that the x coordinate is relative to.
    ...
    def with_position_y(self, y: float, *, frame: Optional[str] = None) -> "Pose":
        ...
        Args:
            ...
            frame: The frame that the y coordinate is relative to.
    ...
    def with_position_z(self, z: float, *, frame: Optional[str] = None) -> "Pose":
        ...
        Args:
            ...
            frame: The frame that the z coordinate is relative to.
    ...
    def rotate_about_axis(self, axis: Sequence[float], angle: float, *, frame: Optional[str]=None) -> "Pose":
        ...
        Args:
            ...
            frame: The frame that the axis is relative to.
    ...
    def distance_to(self, target: "Pose") -> float:
        ...
        """
        return np.linalg.norm(self.position - target.in_frame(self.frame).position)
